      ...
      <div className="w-3/5 space-y-10 pb-10">
        ...
        <div className="flex justify-around space-x-12">
          ...
          <div className="space-y-4 flex flex-col items-center">
            <img
              className="w-28 h-28"
              src="https://cdn.pixabay.com/photo/2018/11/18/19/18/target-3823872__340.png"
              alt=""
            />
            <div className="space-y-1">
              ...
              <p className="text-sm font-extralight w-80">
                ...
                Technical Conferences and Coaching Camps.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 flex flex-col items-center">
            <img
              className="w-28 h-28"
              src="https://seeklogo.com/images/I/information-desk-symbol-logo-871156055D-seeklogo.com.png"
              alt=""
            />
            <div className="space-y-1">
